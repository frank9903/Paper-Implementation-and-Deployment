...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            class_loss = KL.Lambda(lambda x: modellib.mrcnn_class_loss_graph(*x), name="mrcnn_class_loss")(
...
# Create model
model = MaskRCNN(mode="training", config=config, model_dir="/content/Mask_RCNN/logs")
